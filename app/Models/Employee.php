...
class Employee extends Model
{
	...
	protected $fillable = [
		...
		'travel_id','promotion_id','complain_id','warning_id','termination_id','attendance_type','total_leave','remaining_leave','pension_type','pension_amount', 'salary_type', 'employee_grade'];
