...
<section>
    ...
    <div class="container-fluid mb-3">
        ...
        <div class="mb-3 ">
            ...
            <form method="post" id="sample_form" action="{{route('usd-taxtables.store')}}" class="form-horizontal" enctype="multipart/form-data">
